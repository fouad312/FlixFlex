...
import 'package:fixflex/Athentification/SIgnUp.dart';
    ...
    if (formdata!.validate()) {
      if (firstName.text != "" && lastName.text != "") {
        if (agree == true) {
          ...
          alert(
              context, "Erreur", "veuillez accepter les termes et conditions");
          return false;
        }
      } else {
        alert(context, "Erreur", "Complète ajouter tes informations");
        return false;
      }
    } else {
      alert(context, "Erreur", "Complète ajouter tes informations");
              ...
              if (widget.signIn == true) {
                ...
                if (testOthers() == true) {
                  if (exist == false) {
                    ...
                    alert(context, "Erreur", "Ce numéro est déjà utilisé");
                  }
                }
              }
